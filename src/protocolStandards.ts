...
const COMPOUND_CATALOG: CompoundCatalogEntry[] = [
  ...
  { name: "Hexarelin" },
  { name: "AOD-9604" },
  { name: "GHK-Cu", aliases: ["GHK CU", "Copper Peptide", "Copper Tripeptide-1"] },
  { name: "MOTS-c", aliases: ["MOTS C"] },
  { name: "Epitalon", aliases: ["Epithalon"] },
  { name: "Selank" },
  { name: "Semax" },
  { name: "KPV", aliases: ["Lysine Proline Valine"] },
  { name: "Thymosin Alpha-1", aliases: ["TA1", "Thymalfasin"] },
  { name: "Kisspeptin-10", aliases: ["Kisspeptin"] },
  { name: "IGF-1 DES", aliases: ["IGF-1 DES(1-3)", "IGF1 DES"] },
  { name: "PEG-MGF", aliases: ["Pegylated MGF"] },
  { name: "Tesamorelin" },
...
const SUPPLEMENT_CATALOG: SupplementCatalogEntry[] = [
  ...
  { name: "Vardenafil", aliases: ["Levitra"] },
  { name: "Bremelanotide", aliases: ["PT-141"] },
  { name: "Metformin" },
  { name: "Acarbose" },
  { name: "Telmisartan" },
  { name: "Nebivolol" },
  ...
  { name: "Caffeine" },
  { name: "Theobromine" },
  { name: "Alpha-GPC", aliases: ["Alpha GPC"] },
  { name: "Citicoline", aliases: ["CDP-Choline", "CDP Choline"] },
  { name: "Phosphatidylserine", aliases: ["PS"] },
  { name: "Acetyl-L-Carnitine", aliases: ["ALCAR"] },
  { name: "Nicotinamide Riboside", aliases: ["NR"] },
  { name: "Nicotinamide Mononucleotide", aliases: ["NMN"] },
  { name: "Spermidine" },
  { name: "Fisetin" },
  { name: "Pterostilbene" },
  { name: "Sulforaphane", aliases: ["Broccoli Sprout Extract"] },
  { name: "Methylene Blue" },
  { name: "Ginkgo Biloba", aliases: ["Ginkgo"] },
  { name: "Bacopa Monnieri", aliases: ["Bacopa"] },
  { name: "N-Acetyl-L-Tyrosine", aliases: ["NALT"] },
  { name: "Luteolin" },
  { name: "Urolithin A" },
  { name: "PQQ + CoQ10" },
