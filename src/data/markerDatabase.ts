...
export const MARKER_DATABASE: CanonicalMarker[] = [
  ...
  marker({
    ...
    aliases: ["wbc", "white blood cells", "leukocyten", "leukozyten", "white cells", "leucocytes"],
  ...
  marker({
    ...
    category: "Complete Blood Count",
    aliases: ["rbc", "red blood cells", "erythrocyten", "rode bloedcellen", "erythrozyten"],
  ...
  marker({
    ...
    category: "Complete Blood Count",
    aliases: ["thrombocytes", "trombocyten", "bloedplaatjes", "plt"],
    preferredUnit: "x10^9/L",
  ...
  marker({
    ...
    category: "Kidney Function",
    aliases: ["bun creatinine ratio", "urea creatinine ratio"],
    preferredUnit: "ratio",
    alternateUnits: [],
    defaultRangeType: "min-max",
  ...
  marker({
    ...
    aliases: ["testosteron", "testosterone", "testosteron totaal", "total testosterone", "tt"],
    preferredUnit: "nmol/L",
  ...
  marker({
    ...
    category: "Hormones - Sex",
    aliases: ["e2", "oestradiol", "estradiol (17-beta-estradiol)", "17beta estradiol"],
    preferredUnit: "pmol/L",
    alternateUnits: ["pg/mL"],
    defaultRangeType: "min-max",
  ...
  marker({
    ...
    canonicalName: "SHBG",
    category: "Hormones - Sex",
    aliases: ["sex hormone binding globulin", "geslachtshormoonbindend globuline", "sexualhormon-bindendes globulin"],
    preferredUnit: "nmol/L",
    alternateUnits: [],
    defaultRangeType: "min-max",
  ...
  marker({
    ...
    category: "Electrolytes",
    aliases: ["bicarbonaat", "hco3", "co2 total"],
    preferredUnit: "mmol/L",
    alternateUnits: [],
    defaultRangeType: "min-max",
